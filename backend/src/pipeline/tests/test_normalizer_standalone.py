"""Standalone tests for normalizer (no pytest required)."""
...
from pipeline.normalizer import normalize_extracted_data
...
def test_normalize_empty_data():
    ...
    print("✓ test_normalize_empty_data passed")
...
def test_normalize_string_to_list():
    ...
    print("✓ test_normalize_string_to_list passed")
...
def test_normalize_skills_deduplication():
    ...
    print("✓ test_normalize_skills_deduplication passed")
...
def test_normalize_skills_order():
    ...
    print("✓ test_normalize_skills_order passed")
...
def test_normalize_experience_types():
    ...
    print("✓ test_normalize_experience_types passed")
...
def test_normalize_pages():
    ...
    print("✓ test_normalize_pages passed")
...
def test_normalize_types_exact():
    ...
    assert isinstance(result["no_of_pages"], int)
    print("✓ test_normalize_types_exact passed")
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_normalize_string_to_list()
        test_normalize_skills_deduplication()
        test_normalize_skills_order()
